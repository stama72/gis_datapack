...
execute as @a at @s if predicate gis:in_puzzle_s in gis:gis_nether run setblock -7 27 -98 minecraft:air
execute as @a at @s if predicate gis:in_puzzle_s in gis:gis_nether run clone -7 36 -91 -7 36 -91 -7 27 -98
execute as @a at @s if predicate gis:in_puzzle_s in gis:gis_nether if block -9 28 -98 minecraft:dead_brain_coral_block run clone -7 36 -93 -7 36 -93 -9 28 -98 replace force
