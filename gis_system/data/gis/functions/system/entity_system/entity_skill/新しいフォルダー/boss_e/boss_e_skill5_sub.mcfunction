execute in minecraft:end_boss as 0000006e-0000-0000-0000-000300000002 at @s positioned 0 76 0 run function gis:mob/mobskill/boss_e/sub/particle_8
...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000300000002 at @s run schedule function gis:mob/mobskill/boss_e/boss_e_skill5_sub 7t append
