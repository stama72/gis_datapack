...
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill_s
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill1_sub
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill2_sub
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill3_sub
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill4_sub1
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill4_sub2
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill4_sub3
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill4_sub4
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill4_sub5
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill5_sub
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run schedule clear boss_n_skill6_sub
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace fire
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace lava
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run fill 186 22 -18 153 30 15 minecraft:air replace magma_block
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run function gis:other/bossber_set
execute if score #nether_boss instant matches -1 in minecraft:gis_nether run scoreboard players set #nether_boss instant 1
#0noboss
#1standby
#2boss1
execute if score #nether_boss instant matches 2.. in minecraft:gis_nether unless entity @a[x=143,y=17,z=-28,dx=53,dy=26,dz=53,nbt={Dimension:"minecraft:gis_nether"}] run scoreboard players set #nether_boss instant -1
...
#-2
execute if score #nether_boss instant matches -2 in minecraft:gis_nether run scoreboard players set #nether_boss instant 2
#3killboss
...
execute if score #nether_boss instant matches 3 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace fire
execute if score #nether_boss instant matches 3 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace lava
execute if score #nether_boss instant matches 3 in minecraft:gis_nether run fill 186 22 -18 153 30 15 minecraft:air replace magma_block
...
execute if score #nether_boss instant matches 3 in minecraft:gis_nether run scoreboard players set #nether_boss instant 4
#4break
#5boss2standby
...
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace fire
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace lava
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run fill 186 22 -18 153 30 15 minecraft:air replace magma_block
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:witch 170.0 22.00 -1.0 {DeathLootTable:"",UUID:[I;110,0,2,0],CustomNameVisible:1b,Health:3000f,Tags:["gis_mob"],CustomName:'{"text":"業火の魔術師"}',Attributes:[{Name:generic.max_health,Base:3000}]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:marker 170.0 22.00 0.0 {UUID:[I;110,0,2,1],Tags:["gis_mob"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:marker 170.0 22.00 1.0 {UUID:[I;110,0,2,2],Tags:["gis_mob"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:marker 170.0 22.00 2.0 {UUID:[I;110,0,2,3],Tags:["gis_mob"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:magma_cube 190.00 22.50 19.00 {Tags:["gis_mob","gis_spawner_m","gis_kill","ske_crimson"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:magma_cube 190.00 22.50 -21.00 {Tags:["gis_mob","gis_spawner_m","gis_kill","ske_crimson"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:magma_cube 150.00 22.50 19.00 {Tags:["gis_mob","gis_spawner_m","gis_kill","ske_crimson"]}
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run summon minecraft:magma_cube 150.00 22.50 -21.00 {Tags:["gis_mob","gis_spawner_m","gis_kill","ske_crimson"]}
execute if score #nether_boss instant matches 5 run function gis:other/bossber_set
execute if score #nether_boss instant matches 5 in minecraft:gis_nether run scoreboard players set #nether_boss instant 6
#6boss2
...
execute if score #nether_boss instant matches 6 if score #nether_boss gis_min_coal matches 60 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace fire
execute if score #nether_boss instant matches 6 if score #nether_boss gis_min_coal matches 60 in minecraft:gis_nether run fill 186 22 -18 153 30 15 minecraft:air replace magma_block
...
execute if score #nether_boss instant matches 6 in minecraft:gis_nether as 0000006e-0000-0000-0000-000200000003 at @s run tp @s ~ ~ ~ ~3 ~
execute if score #nether_boss instant matches 6 in minecraft:gis_nether as 0000006e-0000-0000-0000-000200000002 at 0000006e-0000-0000-0000-000200000003 positioned ^ ^1 ^1 rotated as @s run tp @s ~ ~ ~ ~-5 ~
execute if score #nether_boss instant matches 6 in minecraft:gis_nether as 0000006e-0000-0000-0000-000200000001 at 0000006e-0000-0000-0000-000200000002 positioned ^ ^1 ^1 rotated as @s run tp @s ~ ~ ~ ~7 ~
execute if score #nether_boss instant matches 6 in minecraft:gis_nether as 0000006e-0000-0000-0000-000200000000 at 0000006e-0000-0000-0000-000200000001 positioned ^ ^2 ^1 facing entity @p eyes run tp @s ~ ~ ~ ~ ~
...
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace fire
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run fill 186 22 -18 153 22 15 minecraft:air replace lava
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run fill 186 22 -18 153 30 15 minecraft:air replace magma_block
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill_s
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill1_sub
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill2_sub
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill3_sub
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill4_sub1
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill4_sub2
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill4_sub3
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill4_sub4
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill4_sub5
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill5_sub
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run schedule clear boss_n_skill6_sub
...
execute if score #nether_boss instant matches 7 in minecraft:gis_nether run scoreboard players set #nether_boss instant 8
