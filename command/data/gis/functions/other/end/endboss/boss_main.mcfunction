#main
execute if score #end_boss instant matches 2..3 unless entity @a[nbt={Dimension:"minecraft:end_boss"}] run scoreboard players set #end_boss instant 0
#0reset
execute if score #end_boss instant matches 0 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill5_sub
execute if score #end_boss instant matches 0 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill7_sub
execute if score #end_boss instant matches 0 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill8_sub
execute if score #end_boss instant matches 0 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill8_sub2
execute if score #end_boss instant matches 0 in minecraft:end_boss run scoreboard players set #end_boss instant_sub 0
execute if score #end_boss instant matches 0 in minecraft:end_boss run function gis:other/bossber_set
execute if score #end_boss instant matches 0 in minecraft:end_boss run kill 0000006e-0000-0000-0000-000300000000
execute if score #end_boss instant matches 0 in minecraft:end_boss as @e[tag=gis_mob] at @s if predicate gis:in_boss_e run kill @s
...
execute if score #end_boss instant matches 0 in minecraft:end_boss run scoreboard players set #end_boss instant 1
#1standby
execute if score #end_boss instant matches 1 if entity @a[nbt={Dimension:"minecraft:end_boss"}] run scoreboard players set #end_boss instant 2
#2summon
execute if score #end_boss instant matches 2 in minecraft:end_boss run scoreboard players add #end_boss instant_sub 1
...
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 1 in minecraft:end_boss run function gis:other/bossber_set
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 1..100 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run function gis:mob/mobskill/boss_e/sub/particle_1
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 1..95 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run particle minecraft:enchant ~ ~2 ~ 0 0 0 1 100
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 1 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run playsound minecraft:entity.ender_dragon.growl player @a ~ ~ ~ 2 0
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 10 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run playsound minecraft:entity.ender_dragon.growl player @a ~ ~ ~ 2 0
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 40 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run playsound minecraft:entity.ender_dragon.growl player @a ~ ~ ~ 2 0
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 70 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run playsound minecraft:entity.ender_dragon.growl player @a ~ ~ ~ 2 0
execute if score #end_boss instant matches 2 if score #end_boss instant_sub matches 100 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run playsound minecraft:item.totem.use player @a ~ ~ ~ 2 2
...
execute if score #end_boss instant matches 3 as 0000006e-0000-0000-0000-000300000000 at @s[tag=!gis_eb_h] if score @s instant matches ..512 run tellraw @a[nbt={Dimension:"minecraft:end_boss"}] {"text":"全テヲ破壊シ尽クスノダ……"}
...
execute if score #end_boss instant matches 3 unless entity 0000006e-0000-0000-0000-000300000000 if entity @a[nbt={Dimension:"minecraft:end_boss"}] run scoreboard players set #end_boss instant 4
#4bosskill
execute if score #end_boss instant matches 4 in minecraft:end_boss run function gis:other/bossber_set
execute if score #end_boss instant matches 4 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill5_sub
execute if score #end_boss instant matches 4 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill7_sub
execute if score #end_boss instant matches 4 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill8_sub
execute if score #end_boss instant matches 4 in minecraft:end_boss run schedule clear gis:mob/mobskill/boss_e/boss_e_skill8_sub2
...
execute if score #end_boss instant matches 4 in minecraft:end_boss as @e[tag=gis_mob] at @s if predicate gis:in_boss_e run kill @s
execute if score #end_boss instant matches 4 in minecraft:end_boss run scoreboard players set #end_boss instant_sub 0
execute if score #end_boss instant matches 4 in minecraft:end_boss run scoreboard players set #end_boss instant 5
#5gatesummon
execute if score #end_boss instant matches 5 in minecraft:end_boss run scoreboard players add #end_boss instant_sub 1
...
execute in minecraft:end_boss if score #end_boss instant matches 5 if score #end_boss instant_sub matches 1..100 positioned 0 64 0 run particle minecraft:explosion_emitter ~ ~ ~ 1 1 1 1 1
execute in minecraft:end_boss if score #end_boss instant matches 5 if score #end_boss instant_sub matches 100 run setblock -2 55 -3 minecraft:redstone_block
execute in minecraft:end_boss if score #end_boss instant matches 5 if score #end_boss instant_sub matches 100 run scoreboard players set #end_boss instant 6
#6noboss
