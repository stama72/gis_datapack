...
execute as @a[x=143,y=17,z=-28,dx=53,dy=26,dz=53,nbt={Dimension:"gis:gis_nether"},scores={leave_game=1..}] at @s run tag @s add killed_nether_boss
execute as @a[x=143,y=17,z=-28,dx=53,dy=26,dz=53,nbt={Dimension:"gis:gis_nether"},scores={leave_game=1..}] at @s run execute in gis:gis_nether run tp @s 124.00 19.06 -5.0 270 0
...
#落し物
execute as @a[scores={deathCount=1..},tag=!gis_itemkeep] at @s run execute as @e[type=minecraft:item,distance=..10] at @s if predicate gis:in_boss_n run execute in gis:gis_nether run tp @s 99.47 22.69 4.54 180.03 -2.20
...
execute as @a[scores={deathCount=1..},advancements={gis:other/tutorial=false}] in gis:tutorial run tp @s 0.5 127.00 0.5 270 0
...
execute in gis:gis_nether run tp @a[nbt={Dimension:"minecraft:the_nether"}] -30.70 19.00 0.65 270 0
execute as @a[nbt={Dimension:"gis:gis_nether",PortalCooldown:0}] at @s if block ~ ~ ~ minecraft:nether_portal in minecraft:overworld run tp @s 77.50 58.00 -16.50 0 0
...
#nether_boss
execute if entity @a[nbt={Dimension:"gis:gis_nether"}] run schedule function gis:other/nether/boss/boss_main 2t append
#end_boss
execute if entity @a[nbt={Dimension:"gis:end_boss"}] run schedule function gis:other/end/endboss/boss_main 2t append
#scorereset
