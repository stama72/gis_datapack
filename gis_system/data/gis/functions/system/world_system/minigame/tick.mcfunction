...
execute if score #minegame instant_sub matches 1 run function gis:system/world_system/minigame/minegame/minegame_main
execute if score #minegame instant_sub matches 2 run function gis:system/world_system/minigame/minegame/end_game
