...
give @p minecraft:oak_sign{display: {Name: '{"text":"ホテル入口へ"}'},BlockEntityTag: {Color:"green",GlowingText:1b,Text1:'{"text":""}',Text2:'{"color":"green","clickEvent":{"action":"run_command","value":"/execute in minecraft:overworld run tp @s 155.0 14 59.0 90 0"},"text":"ホテル入口へ"}',Text3:'{"text":""}',Text4:'{"color":"green","clickEvent":{"action":"run_command","value":"/function gis:system/sign_click/sound_sign_click"},"text":"≪右クリック≫"}'}}
...
give @p minecraft:oak_sign{display: {Name: '{"text":"フードコートへ行く"}'},BlockEntityTag: {Color:"cyan",GlowingText:1b,Text1:'{"clickEvent":{"action":"run_command","value":"/function gis:system/sign_click/sound_sign_click"},"text":" "}',Text2:'{"text":"フードコートへ行く"}',Text3:'{"text":""}',Text4:'{"clickEvent":{"action":"run_command","value":"/execute in minecraft:overworld run tp @s 241.00 2.10 59.00 90 0"},"text":"≪右クリック≫"}', id: "minecraft:sign"}}

#フロント前へ行く
give @p minecraft:oak_sign{display: {Name: '{"text":"フロント前へ行く"}'},BlockEntityTag: {GlowingText: 1b, Color: "red", Text4: '{"clickEvent":{"action":"run_command","value":"/execute in minecraft:overworld run tp @s 220.50 18.10 59.00 -90 0"},"text":"≪右クリック≫"}', Text3: '{"text":""}', Text2: '{"text":"フロント前へ行く"}', Text1: '{"clickEvent":{"action":"run_command","value":"/function gis:system/sign_click/sound_sign_click"},"text":" "}', id: "minecraft:sign"}} 1
