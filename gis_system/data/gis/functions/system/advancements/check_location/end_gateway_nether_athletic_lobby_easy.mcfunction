...
execute if predicate gis:system/entity_check/have_no_item run function gis:system/sub_function/warp_nether_athletic_easy
...
advancement revoke @s only gis:system/check_location/end_gateway_nether_athletic_lobby_easy